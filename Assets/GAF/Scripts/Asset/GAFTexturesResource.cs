...
#if UNITY_EDITOR
	private static readonly string m_sBatchableObjectShaderPath = "Particles/Alpha Blended";
#endif // UNITY_EDITOR
	
	private static readonly string m_sColorizedObjectShaderPath = "GAF/GAFObject";
